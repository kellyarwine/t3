...
describe T3::Game do
  ...
  let(:subject)             { T3::Game.new(io, prompter, double(:configurations, players: players, board: board, game_rules: game_rules, validations: validations, io: io, player_1: player_1, player_2: player_2))   }
  let(:game_with_player_3)  { T3::Game.new(io, prompter, double(:configurations, players: players_2, board: board, game_rules: game_rules, validations: validations, io: io, player_1: player_1, player_2: player_3)) }

  it "has an io and a prompter attribute" do
  ...
  it "sets the configurations instance correctly" do
    subject.configurations.board.should == board
  end
