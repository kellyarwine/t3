...
describe T3::UiIo do
  ...
  xit "has an input and output" do
  ...
  xit "prompts the player for their board choice and receives their input" do
  ...
  xit "prompts the player for their gamepiece choice and receives their input" do
    subject.output.should_receive(:puts).with("Choose any letter to be the gamepiece.")
    subject.display_gamepiece_prompt
  end

  xit "prompts the player for the turn order" do
  ...
  context "#construct gameboard" do
    ...
    xit "displays a full gameboard" do
